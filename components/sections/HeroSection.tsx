...
const AnimatedButtonRow = ({ links, width }: { links: Record<string, string>; width: number }) => (
  <div
    style={{
      display: "flex",
      flexDirection: "row",
    ...
    >
      ...
      >
        <motion.div
          ...
          transition={{ delay: .8, duration: 1, ease }}
        >
          <h1
            style={{
        ...
        <motion.div
          initial={{ opacity: 0, transform: "translateY(-40px) translateX(40px)" }}
